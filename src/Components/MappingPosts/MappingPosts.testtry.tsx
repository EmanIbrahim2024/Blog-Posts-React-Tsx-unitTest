...
// const mockPosts = [
//   { id: "1", title: "Post One" ,content:"content 1",timestamp:"now",Auther:"Eman"},
//   { id: "2", title: "Post Two" ,content:"content 1",timestamp:"now",Auther:"Eman" },
//   { id: "3", title: "Post Three" ,content:"content 1",timestamp:"now",Auther:"Eman"},
//   { id: "4", title: "Post Four" ,content:"content 1",timestamp:"now",Auther:"Eman"},
//   { id: "5", title: "Post Five",content:"content 1",timestamp:"now",Auther:"Eman" },
// ];
...
// test.only("clicking handle Edit get Edit page", () => {
//   render(
//     <MemoryRouter>
//         <MapingPosts
//       userPosts={mockPosts}
